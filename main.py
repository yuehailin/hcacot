...
parser.add_argument('--results_dir', default='', help='results directory (default: ./results)')
...
parser.add_argument('--model_type', type=str, choices=['DeepMISL','HVTSurv','SHFormer','AdvMIL','ViLAMIL','FOCUS','MSCPT','QPMIL','DETA','GCoT','I2HGC','HCACoT'], default='HCACoT', help='type of model')
...
parser.add_argument("--text_prompt_path", type=str, default='.csv')
...
log_file = ''+'20X/'+args.cancer+'/'+args.model_type+'/'
